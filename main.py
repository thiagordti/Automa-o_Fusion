if __name__ == "__main__":
    ...
    from context import set_automacao_fusion_instance
    import os
    import traceback 
    ...
    while True:
        ...
        try:
            ...
            if escolha == 1:
                ...
                global_instance = AutomacaoFusion(caminho, navegador, planilha, planilha_destino, local_destino, cod_filial='01MG0014', cod_uo='10310', tempo_espera=0.5)
                set_automacao_fusion_instance(global_instance)
